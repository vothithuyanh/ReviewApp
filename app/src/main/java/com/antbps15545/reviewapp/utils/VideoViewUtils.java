package com.antbps15545.reviewapp.utils;
...
public class VideoViewUtils {
    ...
    public static final String RAW_VIDEO_SAMPLE = "baihocthanhcong";
    public static final String LOCAL_VIDEO_SAMPLE ="thayhuan";
    public static final String URL_VIDEO_SAMPLE  = "https://www.youtube.com/watch?v=zSOJk7ggJts";
    ...
    public static void playLocalVideo(Context context, VideoView videoView, String localPath)  {
        try {
            int id = VideoViewUtils.getRawResIdByName( context, localPath);
